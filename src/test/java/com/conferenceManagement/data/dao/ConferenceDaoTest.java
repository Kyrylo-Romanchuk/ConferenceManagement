...
public class ConferenceDaoTest {
    ...
    public void init() throws ParseException {
        ...
        conferences.add(new Conference(1, "About Business", simpleDateFormat.parse("05/05/1995 10:00"), users.get(2),
                ...
                35));
        conferences.add(new Conference(2, "About games", simpleDateFormat.parse("05/06/1995 11:00"), users.get(2),
